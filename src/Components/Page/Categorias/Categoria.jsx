...
const Categoria = () => {
  ...
  return (
    <div className="container-categorias">
      <img
        className="image-categorias"
        src="https://res.cloudinary.com/dcf9eqqgt/image/upload/v1689022071/E-COMERCE%20CODER/subcategoria_default_u119l7.jpg"
      ></img>
                  ...
                  <div key={elemento}>
                    ...
                    >
                      ...
                      <Box sx={{ display: "flex", flexDirection: "column" }}>
                        <Skeleton
                          variant="text"
                          sx={{ fontSize: "1.3rem", marginRight: "50px" }}
                          width={400}
                          height={30}
                        />
                        <Skeleton
