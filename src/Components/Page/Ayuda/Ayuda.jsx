      ...
      <div className="container-ayuda">
        <div className="container-ayuda-titulo">
          ...
          <KeyboardBackspaceIcon
            fontSize="large"
            style={{ color: "#fd611a", cursor: "pointer" }}
          />
        </div>
        ...
        <div className="container-ayuda-acordiones">
          <AcordionAyuda
            ...
            subtitulo={"¿Cómo realizo un pedido?"}
            text={
          ...
          <AcordionAyuda
            titulo={"Mercadopago"}
            subtitulo={"¿Cómo puedo abonar a través de MercadoPago?"}
            text={
          ...
          <AcordionAyuda
            titulo={"Envíos"}
            subtitulo={"¿Cómo gestiono el envío de mi pedido?"}
            text={
          ...
          <AcordionAyuda
            titulo={"Facturación"}
            subtitulo={"¿Cómo tramito la factura de mi compra?"}
            text={
        ...
        <div>
          <CajaAyuda
            titulo={"Servicio postventa y garantía"}
            subTexto={
              "También podes sacar un turno para venir en forma presencial a gestionar tu garantía: "
            }
            texto={
